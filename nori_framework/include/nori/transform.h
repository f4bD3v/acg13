...
public:
	...
	inline Ray3f operator*(const Ray3f &r) const {
        ...
        /// Return a pointer to the transform data
        inline const float *data() const { return m_transform.data(); }
        inline float *data() { return m_transform.data(); }

	/// Return a string representation
	QString toString() const;
        QString toLineString() const;
private:
